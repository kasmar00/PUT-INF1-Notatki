...
\subsection{Zasada włączania i wyłączania}
	...
	Aby znaleźć liczbę elementów zbioru $|A_1\cap A_2\cap \hdots \cap A_3|$ należy zanalizować wszystkie możliwe przecięcia (części wspólne) zbiorów z rodziny $(A_1, A_2, \dots ,A_n)$ i odać liczność przecięć nieparzystej liczby zbiorów oraz odjąć liczność przecięć nieparzystej liczby zbiorów.\\
